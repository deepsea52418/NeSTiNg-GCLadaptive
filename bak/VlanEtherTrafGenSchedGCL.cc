...
void VlanEtherTrafGenSched::initialize(int stage) {
    if (stage == INITSTAGE_LOCAL) {
        ...
        // gateController2 = getModuleFromPar<GateController>(
        //         par("gateControllerModule2"), this);
        // gateController3 = getModuleFromPar<GateController>(
        //         par("gateControllerModule3"), this);
        // gateController4 = getModuleFromPar<GateController>(
        //         par("gateControllerModule4"), this);
        
        std::string filename = (&par("result_file_location"))->stringValue() ;
        this->result_file.open(filename, std::ios::out | std::ios::trunc);
...
void VlanEtherTrafGenSched::receivePacket(Packet *pkt) {
        ...
        auto src = msg->getTag<MacAddressInd>()->getSrcAddress();
        auto dest = msg->getTag<MacAddressInd>()->getDestAddress();
        // 根据流量的发送方和接收方确定gatecontroler选择哪两个
        GateController* gateController_com1;
        // GateController* gateController_com2;
        // if ((src == MacAddress("00-00-00-00-00-01") || src == MacAddress("00-00-00-00-00-02") || src == MacAddress("00-00-00-00-00-03")) \
        //         && (dest == MacAddress("00-00-00-00-00-04") || dest == MacAddress("00-00-00-00-00-05") ||dest == MacAddress("00-00-00-00-00-06")) )
        // {
        //     gateController_com1 = this->gateController2; // a交换机端口4
        //     gateController_com2 = this->gateController4; // c交换机端口3
        // }else if ((src == MacAddress("00-00-00-00-00-07") || src == MacAddress("00-00-00-00-00-08") ) \
        //         && (dest == MacAddress("00-00-00-00-00-04") || dest == MacAddress("00-00-00-00-00-05") ||dest == MacAddress("00-00-00-00-00-06")))
        // {
        //     gateController_com1 = this->gateController1; // a交换机端口3
        //     gateController_com2 = this->gateController3; // b交换机端口2
        // }else if ((src == MacAddress("00-00-00-00-00-07") || src == MacAddress("00-00-00-00-00-08") ) \
        //         && (dest == MacAddress("00-00-00-00-00-01") || dest == MacAddress("00-00-00-00-00-02") ||dest == MacAddress("00-00-00-00-00-03")))
        // {
        //     gateController_com1 = this->gateController2; // c交换机端口4
        //     gateController_com2 = this->gateController4; // b交换机端口3
        // }else if ((src == MacAddress("00-00-00-00-00-04") || src == MacAddress("00-00-00-00-00-05") || src == MacAddress("00-00-00-00-00-06") ) \
        //         && (dest == MacAddress("00-00-00-00-00-01") || dest == MacAddress("00-00-00-00-00-02") ||dest == MacAddress("00-00-00-00-00-03")))
        // {
        //     gateController_com1 = this->gateController1; // c交换机端口3
        //     gateController_com2 = this->gateController3; // a交换机端口4
        // }else if ((src == MacAddress("00-00-00-00-00-04") || src == MacAddress("00-00-00-00-00-05") || src == MacAddress("00-00-00-00-00-06") ) \
        //         && (dest == MacAddress("00-00-00-00-00-07") || dest == MacAddress("00-00-00-00-00-08") ))
        // {
        //     gateController_com1 = this->gateController1; // b交换机端口2
        //     gateController_com2 = this->gateController3; // a交换机端口3
        // }else if ((src == MacAddress("00-00-00-00-00-01") || src == MacAddress("00-00-00-00-00-02") || src == MacAddress("00-00-00-00-00-03") ) \
        //         && (dest == MacAddress("00-00-00-00-00-07") || dest == MacAddress("00-00-00-00-00-08") ))
        // {
        //     gateController_com1 = this->gateController2; // b交换机端口3
        //     gateController_com2 = this->gateController4; // c交换机端口4
        // }else
        // {
        //     EV_INFO << "unknown traffic" ;
        // }      
        ...
        this->result_file << "{ \"time\": "<<simTime() << ", \"src\": \"" << msg->getTag<MacAddressInd>()->getSrcAddress() << "\"" \
         ...
         // AWS 调节算法
        if ( msg->getTag<EnhancedVlanInd>()->getPcp() == 7 && delay > SimTime(150, SIMTIME_US)) 
        {
            Schedule<GateBitvector>* currentSchedule1 = gateController_com1->getCurrentSchedule();
            Schedule<GateBitvector> nextSchedule1;
            GateBitvector bitvector1 = currentSchedule1->getScheduledObject(0);
            simtime_t time_interval1 = currentSchedule1->getTimeInterval(0);
            simtime_t schedule_cycle1 = currentSchedule1->getCycleTime();

            // Schedule<GateBitvector>* currentSchedule2 = gateController_com2->getCurrentSchedule();
            // Schedule<GateBitvector> nextSchedule2;
            // GateBitvector bitvector2 = currentSchedule2->getScheduledObject(0);
            // simtime_t time_interval2 = currentSchedule2->getTimeInterval(0);
            // simtime_t schedule_cycle2 = currentSchedule2->getCycleTime();
        
            // 控制更新
            simtime_t target_time_interval1 = ((time_interval1 + SimTime(100, SIMTIME_US)) > schedule_cycle1 ) ? \
                                               schedule_cycle1 * 0.9 : (time_interval1 + SimTime(100, SIMTIME_US));

            // simtime_t target_time_interval2 = ((time_interval2 + SimTime(100, SIMTIME_US)) > schedule_cycle2 ) ? \
            //                                    schedule_cycle2 * 0.9: (time_interval2 + SimTime(100, SIMTIME_US));

            this->result_file << "{ \"time\": "<< simTime() << ", \"src\": \"" << msg->getTag<MacAddressInd>()->getSrcAddress() << "\"" \
            << ", \"dest\": \"" << msg->getTag<MacAddressInd>()->getDestAddress() << "\"" \
            << ", \"pcp\": " << msg->getTag<EnhancedVlanInd>()->getPcp() \
            << ", \"pcp=7-interval1\": " << target_time_interval1 << ", \"pcp<7-interval1\": " << schedule_cycle1 - target_time_interval1  << " } " \
            << endl;
            // 写回更新          
            nextSchedule1.addControlListEntry(target_time_interval1, currentSchedule1->getScheduledObject(0));
            nextSchedule1.addControlListEntry(schedule_cycle1 - target_time_interval1, currentSchedule1->getScheduledObject(1));
            nextSchedule1.setCycleTime(schedule_cycle1);
            gateController_com1->setNextSchedule(nextSchedule1);

            // nextSchedule2.addControlListEntry(target_time_interval2, currentSchedule2->getScheduledObject(0));
            // nextSchedule2.addControlListEntry(schedule_cycle2 - target_time_interval2, currentSchedule2->getScheduledObject(1));
            // nextSchedule2.setCycleTime(schedule_cycle2);
            // gateController_com2->setNextSchedule(nextSchedule2);   
        }
        

        // aws原论文将阈值设置为最差可接受时延的50%
        if ( msg->getTag<EnhancedVlanInd>()->getPcp() == 7 && delay < SimTime(5, SIMTIME_US))
        {
            Schedule<GateBitvector>* currentSchedule1 = gateController_com1->getCurrentSchedule();
            Schedule<GateBitvector> nextSchedule1;
            GateBitvector bitvector1 = currentSchedule1->getScheduledObject(0);
            ...
            // 控制更新
            simtime_t target_time_interval1 = ((time_interval1 - SimTime(10, SIMTIME_US)) < SimTime(10, SIMTIME_US) ) ? \
                                                SimTime(10, SIMTIME_US) : (time_interval1 - SimTime(10, SIMTIME_US));

            // simtime_t target_time_interval2 = ((time_interval2 - SimTime(10, SIMTIME_US)) < SimTime(10, SIMTIME_US) ) ? \
            //                                    SimTime(10, SIMTIME_US) : (time_interval2 - SimTime(10, SIMTIME_US));
