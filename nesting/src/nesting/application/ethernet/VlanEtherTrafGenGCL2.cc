...
namespace nesting {
    ...
    void VlanEtherTrafGenGCL2::initialize(int stage) {
       ...
       if (stage == INITSTAGE_LOCAL) {
            ...
            transmissionSelection_a = getModuleFromPar<TransmissionSelection>(par("TransmissionSelectionModule_a"), this);
            transmissionSelection_b = getModuleFromPar<TransmissionSelection>(par("TransmissionSelectionModule_b"), this);
