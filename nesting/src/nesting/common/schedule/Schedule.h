...
public:
    ...
    virtual void setScheduledObject(unsigned index, T object) {
        controlList[index].scheduledObject = object;
    }

    virtual void setTimeInterval(unsigned index, simtime_t t) {
        controlList[index].timeInterval = t;
    }
